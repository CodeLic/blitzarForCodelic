...
\r
    <BlitzListForm v-model="formData" class="my-multi-row-form" :schema="schema" />\r
\r
...
<style lang="scss">\r
.my-multi-row-form {\r
  .blitz-list-form__row {\r
    grid-template-columns: 20px 1fr 1fr 100px !important;\r
  }\r
  .blitz-list-form__row > *:last-child {\r
    grid-column: 2 / -1;\r
  }\r
\r
  .delete-button {\r
